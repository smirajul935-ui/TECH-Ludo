...
import { getDatabase, ref, set, get, child, remove, onValue, off, onDisconnect } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-database.js";
...
export { db, ref, set, get, child, remove, onValue, off, onDisconnect };
